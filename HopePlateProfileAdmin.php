...
<body>
	...
	<div class = "profile">
		...
		<div class = "profile-content">
			<div>
			<?php
			     echo "<h3> Admin id: <br> {$_SESSION['admin_id']} </h3>";
		...
		<div style = "display: flex; flex-direction: row; gap: 50px;">
			<button onclick = "window.location.href = 'HopePlateAdminPanel.php';"> ADMIN PANEL </button>
			<button onclick = "window.location.href = 'HopePlateEditProfile.php';"> EDIT PROFILE</button>
